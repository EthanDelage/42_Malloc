 ...
 *
 * Iterates through all pages and their allocated and free chunk lists to
 * determine if the specified chunk is present.
 *
...
/**
 * @brief Checks whether a specific chunk exists within a doubly linked list of
 * chunks.
 *
 * Iterates through the linked list starting from `chunk_head` to determine if
 * the specified chunk is present.
 *
